...
function Skills() {
    return (
        <div className='w-full mt-3 rounded-md pt-3 pb-2 bg-neutral-900'>
            ...
            <div className='flexCenter mt-3 space-y-3     flex-col'>
                <span className='font-bold  text-xs'>TechStack</span>
                <div className=' flex-col space-y-2 flexCenter'>
                    <div className='flexCenter space-x-2 w-full'>
                        {Mainstack1.map((item) => (
                ...
                <div className='w-full border-t-2 border-greenPrimary-1100  flexCenter flex-col gap-y-2'>
