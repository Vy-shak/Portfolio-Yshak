    ...
    return (
        <section className='w-full flexCenter overflow-y-hidden '>
            ...
            <div className='w-full flex justify-center items-center flex-col mt-16'>
                ...
                <div className='flex lg:flex-row flex-col w-full px-12  sm:px-8 md:px-10 lg:px-16'>
                    <div className='w-full z-10 h-60 sm:h-64 lg:h-96 md:h-72 px-8 lg:px-0 sm:px-10 md:px-12 py-4 '>
                    ...
                    <div style={{
                        ...
                        <div className='w-full pt-4 px-2 sm:px-2 md:px-4 lg:p-0 flex space-y-2 md:space-y-2 lg:space-y-4 flex-col items-start justify-start  lg:pt-4  rounded-tr-lg h-fit pb-4   lg:h-full bg-neutral-900'>
                            <h2 className='italic font-semibold lg:text-2xl md:text-2xl sm:text-xl text-lg'>Hello, I’m <span className='text-greenPrimary-600'>Yshak.</span><br />
                            ...
                            <Button variant='primary' size='default' text='see my projects' ></Button>
                        </div>
                    </div>
                </div>
            </div>
